...
public class EnergyPagerAdapter extends FragmentPagerAdapter {
	...
	public Fragment getItem(int position) {
		...
		Fragment fragment = new EnterEnergyConsumptionFragment();
	...
	public CharSequence getPageTitle(int position) {
		...
		switch (position) {
		case 0:
			return this.myEnergyActivity.getString(R.string.title_section1).toUpperCase(l);
		case 1:
			return this.myEnergyActivity.getString(R.string.title_section2).toUpperCase(l);
		}
		return null;
	}
}
